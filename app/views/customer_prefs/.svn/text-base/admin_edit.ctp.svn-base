...
<?php echo $this->Form->create('CustomerPref');?>
	<fieldset>
		<legend><?php __('Admin Edit Customer Pref'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('CustomerPref.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('CustomerPref.id'))); ?></li>
