<div class="cuisineTypes index">
	<h2><?php __('Cuisine Types');?></h2>
	...
	?>
	<tr<?php echo $class;?>>
		<td><?php echo $cuisineType['CuisineType']['id']; ?>&nbsp;</td>
		<td><?php echo $cuisineType['CuisineType']['name']; ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Html->link(__('View', true), array('action' => 'view', $cuisineType['CuisineType']['id'])); ?>
			<?php echo $this->Html->link(__('Edit', true), array('action' => 'edit', $cuisineType['CuisineType']['id'])); ?>
			<?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $cuisineType['CuisineType']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $cuisineType['CuisineType']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
