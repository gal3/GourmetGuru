...
<?php echo $this->Form->create('CuisineType');?>
	<fieldset>
		<legend><?php __('Admin Edit Cuisine Type'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('CuisineType.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('CuisineType.id'))); ?></li>
