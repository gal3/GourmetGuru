...
<?php echo $this->Form->create('FoodReview');?>
	<fieldset>
		<legend><?php __('Admin Edit Food Review'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('FoodReview.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('FoodReview.id'))); ?></li>
