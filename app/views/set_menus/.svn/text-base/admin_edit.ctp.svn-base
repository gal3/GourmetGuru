...
<?php echo $this->Form->create('SetMenu');?>
	<fieldset>
		<legend><?php __('Admin Edit Set Menu'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('SetMenu.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('SetMenu.id'))); ?></li>
